 ...
 */
            ...
            /**
            *  TargetServiceDetails bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = TargetServiceDetails
                Namespace URI = http://util.discovery.carbon.wso2.org/xsd
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String[] localAddresses ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getAddresses(){
                               ...
                               */
                              protected void validateAddresses(java.lang.String[] param){
                              ...
                              */
                              public void setAddresses(java.lang.String[] param){
                             ...
                             */
                             public void addAddresses(java.lang.String param){
                                   if (localAddresses == null){
                                   localAddresses = new java.lang.String[]{};
                                   }
                        ...
                        */
                                    ...
                                    protected java.lang.String[] localScopes ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getScopes(){
                              ...
                              /**
                               * validate the array for Scopes
                               */
                              protected void validateScopes(java.lang.String[] param){
                              ...
                              * @param param Scopes
                              */
                              public void setScopes(java.lang.String[] param){
                              
                                   validateScopes(param);

                               localScopesTracker = true;
                             ...
                             * @param param java.lang.String
                             */
                             public void addScopes(java.lang.String param){
                                   if (localScopes == null){
                                   localScopes = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localScopes);
                               list.add(param);
                               this.localScopes =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://util.discovery.carbon.wso2.org/xsd");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TargetServiceDetails",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localAddressesTracker){
                             if (localAddresses!=null) {
                                   namespace = "http://util.discovery.carbon.wso2.org/xsd";
                                   for (int i = 0;i < localAddresses.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://util.discovery.carbon.wso2.org/xsd", "addresses", xmlWriter);
                             ...
                             if (localScopes!=null) {
                                   namespace = "http://util.discovery.carbon.wso2.org/xsd";
                                   for (int i = 0;i < localScopes.length;i++){
                                        
                                            if (localScopes[i] != null){
                                        
                                                writeStartElement(null, namespace, "scopes", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localScopes[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://util.discovery.carbon.wso2.org/xsd", "scopes", xmlWriter);
                             ...
                             if (localTypes!=null) {
                                   ...
                                   for (int i = 0;i < localTypes.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://util.discovery.carbon.wso2.org/xsd", "types", xmlWriter);
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://util.discovery.carbon.wso2.org/xsd")){
                return "ns1";
            }
                 ...
                 if (localAddressesTracker){
                            if (localAddresses!=null){
                                  for (int i = 0;i < localAddresses.length;i++){
                                         ...
                                         if (localAddresses[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd",
                                                                              "addresses"));
                                          elementList.add(
                                  ...
                                  for (int i = 0;i < localScopes.length;i++){
                                         ...
                                         if (localScopes[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd",
                                                                              "scopes"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localScopes[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static TargetServiceDetails parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TargetServiceDetails object =
                new TargetServiceDetails();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TargetServiceDetails".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TargetServiceDetails)org.wso2.carbon.discovery.admin.stub.types.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","addresses").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","addresses").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setAddresses((java.lang.String[])
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","scopes").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","scopes").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setScopes((java.lang.String[])
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","serviceId").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","types").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","types").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://util.discovery.carbon.wso2.org/xsd","version").equals(reader.getName())){
