...
public class AuthenticationLibrary {
	...
	public AuthenticationLibrary() {
		// get the jks file
		String jks = AutomationConfigurationReader
				.context(AutomationConfigurationReader.PRODUCT_LOCATION)
		...
		String host = AutomationConfigurationReader.context(AutomationConfigurationReader.PRODUCT_HOST); // get
																					// the
																					// host
																					// name
																					// from
																					// automation.xml
		String port = AutomationConfigurationReader.context(AutomationConfigurationReader.PRODUCT_PORT); // get
																					// the
																					// port
																					// name
																					// from
	...
	public String LoginAs(String user) throws Exception {
		...
		String host;
		try {
			username = AutomationConfigurationReader.getUserName(tenet, name); // get the
																	// user name
			password = AutomationConfigurationReader.getPassword(tenet, name); // get the
																	// pass word
			host = AutomationConfigurationReader.getHostName(); // get the default host name
