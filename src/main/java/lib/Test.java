...
public class Test {

	{
		...
		// String a =
		// AutomationContext.context(AutomationContext.PRODUCT_AXIS2);
		// endPOint = a + "/" + endPOint;
		//
		...
		// //
		// //// AxisServiceClient c=new AxisServiceClient();
		// // JarServiceCreatorAdminLibrary l=new
		// JarServiceCreatorAdminLibrary();
		// //
		// // try {
		// // l.initJarServiceCreatorAdmin();
		// //
		// // URL u=new URL("file://" +new
		// File("src/test/resources/artifacts/AS/jar/artifact1/JarService.jar").getAbsolutePath());
		...
		// UploadedFileItem[]
		// o=ASObjectPool.createUploadedFileItems("src/test/resources/artifacts/AS/car/AxisCApp-1.0.0.car");
		// c.uploadApp(o);
		...
		// String
		// res=sl.uploadService(ASObjectPool.createAARServiceData("src/test/resources/artifacts/AS/aar/MTOMService.aar"));
		...
		// File("src/test/resources/artifacts/AS/images/wso2.jpeg"));
		...
		// System.out.println(s.containString(res,
		// "File MTOM Image.jpeg has been successfully saved"));
		...
		// sl.initServiceUploader();
		// String
		// res=sl.uploadService(ASObjectPool.createAARServiceData("src/test/resources/artifacts/AS/aar/CommodityQuoteService.aar"));
		// System.out.println(res);
		// } catch (AxisFault e) {
		// System.out.println("e "+e.getMessage());
		// } catch (Exception e) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// "src/main/resources/");
			// System.out.println(System.getProperty("framework.resource.location"));
			// System.out.println(AutomationContext.getUserName("users","user1"));
			// System.out.println(AutomationContext.getPassword("admin","admin"));
			new Standard();
//			AuthenticationLibrary l = new AuthenticationLibrary();
//			l.LoginAs("admin", "admin", "localhost");
//			l.LoginAs("admin-admin", "localhost");
			String s=AutomationContext.getHostName();
			System.out.println(s);
			s=AutomationContext.context("//userManagement/platform/productGroup[@name='ESB']/instance[@name='esbs001']/hosts/host[@type='default']");
			System.out.println(s);
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println("e " + e.getMessage());
